<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="EzyCards.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<button id="dsf" onclick="GetSessionStorage()" hidden="hidden">Get Value</button>
    <h1>Administration</h1>
    <hr />
    <h3>Add Product:</h3>
    <table>
        <tr><asp:HiddenField ID="PageId" runat="server" />
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="EzyCards.Models.Product" 
